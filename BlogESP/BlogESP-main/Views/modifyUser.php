...
<body>
   <a href="/superUser" class="back"><button>retour au tableau de bord</button></a>
   <div class="container">

      <form action=<?= "/modifier_utilisateur/" . $id ?> method="POST">
         <div class="mb-3">
            <label for="username" class="form-label">username</label>
            <input type="username" class="form-control" name="username" value="<?= $user['username'] ?>" require>
         </div>
         <div class="mb-3">
